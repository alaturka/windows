...
$(if ($PSCulture -eq 'tr-TR') { ConvertFrom-StringData -StringData @'
    ...
    Invalid Home folder name                             = Gecersiz Ev dizin adi
    ...
    PLEASE CHANGE YOUR USER NAME, OR PERHAPS DO A FRESH INSTALLATION OF WINDOWS WITH A PROPER NAME. = LUTFEN KULLANICI ADINIZI DEGISTIRIN, VEYA BELKI DAHA KOLAYI UYGUN BIR KULLANICI ADIYLA YENI BIR WINDOWS KURULUMU YAPIN.
    ...
    YOUR USER NAME, HENCE HOME FOLDER NAME, CONTAINS NON-ASCII CHARACTERS WHICH MAY CAUSE PROBLEMS. = KULLANICI ADINIZ, DOLAYISIYLA EV KLASORUNUZ ASCII OLMAYAN TURKCE KARAKTERLER ICERIYOR KI BU DURUM SORUNLARA YOL ACABILIR.
'@}) | importTranslations
